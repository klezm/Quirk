...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      all: {
        ...
        // tasks: ['build-src'],
        options: {
          livereload: true, // recommended port: 35729
          // livereload: 35729, // recommended port: 35729
          // livereload: {
          //   host: 'localhost',
          //   port: 9000, // recommended port: 35729
          //   // port: 35729,
          // },
          // cwd: 'out/',
          // cwd: {
  ...
  grunt.registerTask('test-perf-chrome', [
    'build-test-perf',
    'karma:perf-chrome',
  ]);
